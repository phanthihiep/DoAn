		...
		<div class="container">
			...
			<div class="load_more">
				<h3 class="w3layouts-title">
					<img src="images/menu1.png" class="img-responsive" alt="" />Menu Restaurant</h3>
				<div class="text-center">
					<button type="button" class="btn" ><i class="fa fa-plus" aria-hidden="true"> &nbsp Thêm Món Ăn</i></button>
				</div>
								...
								<div class="col-md-6 menu-grids">
									...
									<div class="w3l-menu-text">
										<div class="menu-text-left">
											<img src="images/<%=food.getPicture() %>" alt="" style="width: 100px; height: 100px" class="img-responsive" />
										</div>
										<div class="menu-text-right">
											...
											<div class="clearfix"></div>
											<div class="text-center">
												<button type="button" class="btn" ><i i class="fa fa-trash" aria-hidden="true" > &nbsp Xóa</i></button>
											</div>
										</div>
										<div class="clearfix"> </div>
									</div>
