...
<body>
 <% 
 Memb mb = (Memb)request.getAttribute("MB");%> 
	<div class="page-container">
		<div class="left-content">
	   		<div class="inner-content">
				...
				<div class="outter-wp">
				<div class="container">
					<center><h2>Sửa thông tin thành viên</h2></center><br>
					<form action="AdSuaMember" method="post">
						<div class="row form-group">
				            <label class="col-lg-3">ID : </label>
				            <div class="col-lg-4">
				                <input type="text" class=" form-control" name="id" value="<%=mb.getId()%>" readonly/>
				            </div>
				        </div>
				        <div class="row form-group">
				            <label class="col-lg-3">Tên  : </label>
				            <div class="col-lg-4">
				                <input type="text" class=" form-control" name="ten" value="<%=mb.getTen()%>" required/>
				            </div>
				        </div>
				        <div class="row form-group">
				            <label class="col-lg-3">Mật khẩu : </label>
				            <div class="col-lg-4">
				                <input type="text" class=" form-control" name="mk" value="<%=mb.getPass()%>" required/>
				            </div>
				        </div>
				         <div class="row form-group">
				            <label class="col-lg-3">Số điện thoại :</label>
				            <div class="col-lg-4">
				                <input type="text" class="form-control" name="sdt" id="txttendangnhap" value="<%=mb.getSdt()%>" required/>
