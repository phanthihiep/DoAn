...
<body>
 <% Memb member = (Memb) session.getAttribute("user");
	...
	DatBan db = (DatBan)request.getAttribute("Datban");
%>
	<div class="page-container">
		<div class="left-content">
	   		<div class="inner-content">
				...
				<div class="outter-wp">
				<div class="container">
					<center><h2>Xóa lượt đặt bàn</h2></center><br>
					<form action="AdXoaDBServlet" method="post">
				        <div class="row form-group">
				            <label class="col-lg-3">ID : </label>
				            <div class="col-lg-4">
				                <input type="text" class=" form-control" name="id" value="<%=db.getId() %>" readonly="readonly"/>
				            </div>
				        </div>
				        <div class="row form-group">
				            <label class="col-lg-3">Mã nhà hàng :</label>
				            <div class="col-lg-4">
				                <input type="text" class="form-control" name="idMB" value="<%=db.getIdNH() %>" readonly="readonly"/>
				            </div>
				        </div>
				         <div class="row form-group">
				            <label class="col-lg-3">Họ và tên :</label>
				            <div class="col-lg-4">
				                <input type="text" class="form-control" name="ten" value="<%=db.getTen() %>" readonly="readonly"/>
				        ...
				        <div class="row form-group">
				            ...
				            <div class="col-lg-4">
				                <input type="text" class="form-control" name="sdt" value="<%=db.getSdt() %>" readonly="readonly"/>
				            </div>
				        </div>
				        <div class="row form-group">
				            <label class="col-lg-3">Email:</label>
				            <div class="col-lg-4">
				                <input type="text" class="form-control" value="<%=db.getEmail() %>" readonly="readonly"/>
				               
				            </div>
				        </div>
				        <div class="row form-group">
				            <div class="col-lg-4 col-lg-offset-3">
				                <button class="btn btn-primary" type="submit" value="submit" name="submit">Xóa</button>
