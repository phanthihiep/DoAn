	...
	<div class="page-container">
		<div class="left-content">
	   		<div class="inner-content">
				...
				<!-- --------------------------------- -->
				<div class="outter-wp">
					<center><h2>Danh sách lượt đặt bàn của các Nhà Hàng</h2></center>
					<form >
						  <table class="table table-striped">
					           ...
					           <tr>
					                ...
					                <td><%=db.getSdt() %></td>
					                <td>
					                   <a href="/AdXoaDBServlet?id=<%=db.getId() %>" style="margin-left: 30px;"><span class="glyphicon glyphicon-trash"></span></a>
					               </td>
					            </tr>
					            <%} %>
					            </tbody>
			...
			<ul id="menu" >
				...
				<li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Nhà hàng</span> <span class="fa fa-angle-right" style="float: right"></span></a>
				   <ul id="menu-academico-sub" >
						...
						<li id="menu-academico-boletim" ><a href="/AdBaiDangServletl">Bài đăng</a></li>
