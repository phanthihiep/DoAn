	...
	<div class="page-container">
		<div class="left-content">
	   		<div class="inner-content">
				...
				<!-- --------------------------------- -->
				<div class="outter-wp">
					<center><h2>Danh sách các Khách hàng</h2></center>
					<form>
						  <table class="table table-striped">
					            ...
					            <tr>
					             ...
					             <tbody>
					             <%
					            	ArrayList<KhachHang> list = (ArrayList<KhachHang>)request.getAttribute("ListKH");
					            	for(KhachHang kh:list){
					            %>
					            <tr>
					                <th scope="row"><%=kh.getId() %></th>
					                <td><%=kh.getIdMB() %></td>
					                <td><%=kh.getSdt() %></td>
					                <td><%=kh.getDiachi() %></td>
					                <td>
					                    <a href="/AdminGetIdKH?id=<%=kh.getId() %>"><span class="glyphicon glyphicon-edit"></span></a>
