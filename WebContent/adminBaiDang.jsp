	...
	<div class="page-container">
		<div class="left-content">
	   		<div class="inner-content">
				...
				<!-- --------------------------------- -->
				<div class="outter-wp">
					<center><h2>Các Bài Đăng của các Nhà Hàng</h2></center>
					<form >
						  <table class="table table-striped">
					            ...
					            <tbody>
					              <%
						            	ArrayList<BaiDang> list = (ArrayList<BaiDang>)request.getAttribute("List");
						            	for(BaiDang bd:list){
						            %>
					           <tr>
					                <th scope="row"><%=bd.getId() %></th>
					                <td><%=bd.getIdNH() %></td>
					                <td><%=bd.getThongtin() %></td>
					                <td>
					                   <a href="/AdXoaBaiServlet?id=<%=bd.getId() %>" style="margin-left: 30px;"><span class="glyphicon glyphicon-trash"></span></a>
					               </td>
					            </tr>
					            <%} %>
					            </tbody>
