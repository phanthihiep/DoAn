	...
	<div class="page-container">
		<div class="left-content">
	   		<div class="inner-content">
				...
				<!-- --------------------------------- -->
				<div class="outter-wp">
					<center><h2>Danh sách các Nhà Hàng</h2></center>
					<form >
						  <table class="table table-striped">
					            ...
					            <tbody>
					             <%
					            	ArrayList<NhaHang> list = (ArrayList<NhaHang>)request.getAttribute("ListNH");
					            	for(int i=0;i<list.size();i++){
					            		NhaHang nh = list.get(i);
					            %>
					            <tr>
					                <th scope="row"><%=nh.getIdMB()%></th>
					                <td><%=nh.getTenNH() %></td>
					                <td><%=nh.getSdt() %></td>
					                <td><%=nh.getDiaChi() %></td>
					                <td><%=nh.getEmail() %></td>
