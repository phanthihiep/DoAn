...
</html><%@page import="model.bean.NhaHang"%>
<%@page import="model.dao.Admin"%>
<%@page import="java.util.ArrayList"%>
<%@page import="model.bean.Memb"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
...
<body>
 <% Memb mb = (Memb) session.getAttribute("user");
	...
	<div class="page-container">
		<div class="left-content">
	   		<div class="inner-content">
				...
				<div class="outter-wp">
				<div class="container">
					<center><h2>Cập nhật thông tin Khách Hàng</h2></center><br>
					<form action="AdminSuaNHServlet" method="post">
						<div class="row form-group">
				            <label class="col-lg-3">ID : </label>
				            <div class="col-lg-4">
				                <input type="text" class=" form-control" name="id" value="<%=kh.getId()%>" readonly/>
				            </div>
				        </div>
				        <div class="row form-group">
				            <label class="col-lg-3">Mã thành viên : </label>
				            <div class="col-lg-4">
				                <input type="text" class=" form-control" name="idmb" value="<%=kh.getIdMB()%>" required/>
				            </div>
				        </div>
				        <div class="row form-group">
				            <label class="col-lg-3">Địa chỉ :</label>
				         ...
				         <div class="row form-group">
				            <label class="col-lg-3">Số điện thoại :</label>
				            <div class="col-lg-4">
				                <input type="text" class="form-control" name="sdt" id="txttendangnhap" value="<%=kh.getSdt()%>" required/>
				                <span id="spnPhoneStatus"></span>
				            </div>
				        </div>
				        <div class="row form-group">
