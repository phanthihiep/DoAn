...
<body>
 <% Memb member = (Memb) session.getAttribute("user");
	...
	BaiDang db = (BaiDang)request.getAttribute("BaiDang");
%>
	<div class="page-container">
		<div class="left-content">
	   		<div class="inner-content">
				...
				<div class="outter-wp">
				<div class="container">
					<center><h2>Xóa Bài Đăng</h2></center><br>
					<form action="AdXoaBaiServlet" method="post">
				        ...
				        <div class="row form-group">
				            ...
				            <div class="col-lg-4">
				                <input type="text" class="form-control" name="idNH" value="<%=db.getIdNH() %>" readonly="readonly"/>
				            </div>
				        </div>
				         <div class="row form-group">
				            <label class="col-lg-3">Nội dung :</label>
				            <div class="col-lg-4">
				            	<textarea class="form-control" name="noidung" readonly="readonly"><%=db.getThongtin() %></textarea>
