...
/**
 * Servlet implementation class SerchNHServlet
 */
@WebServlet("/SerchNHServlet")
public class SerchNHServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SerchNHServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<NhaHang> list = kh.getListNHSerch(request.getParameter("search"));
